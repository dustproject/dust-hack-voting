...
// equivalent to WorldResourceIdLib.encode({ typeId: RESOURCE_SYSTEM, namespace: "DUST_HACK_1", name: "VotingSystem" }))
VotingSystemType constant votingSystem = VotingSystemType.wrap(
  0x7379445553545f4841434b5f31000000566f74696e6753797374656d00000000
);
