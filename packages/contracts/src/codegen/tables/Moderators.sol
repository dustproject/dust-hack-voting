...
library Moderators {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "DUST_HACK_1", name: "Moderators", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462445553545f4841434b5f310000004d6f64657261746f7273000000000000);
   ...
   */
  function getIsModerator(address user) internal view returns (bool isModerator) {
   ...
   * @notice Get isModerator.
   */
  function _getIsModerator(address user) internal view returns (bool isModerator) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Get isModerator.
   */
  function get(address user) internal view returns (bool isModerator) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Get isModerator.
   */
  function _get(address user) internal view returns (bool isModerator) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   */
  function setIsModerator(address user, bool isModerator) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Set isModerator.
   */
  function _setIsModerator(address user, bool isModerator) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Set isModerator.
   */
  function set(address user, bool isModerator) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
   ...
   * @notice Set isModerator.
   */
  function _set(address user, bool isModerator) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(user)));
